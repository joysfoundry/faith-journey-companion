  ...
  head: () => ({
    meta: [
      { title: "About — ACTS" },
      {
        name: "description",
        content:
          "What ACTS is, the vision behind it, why it's a beta, and how your data stays on your device.",
      },
      { property: "og:title", content: "About — ACTS" },
      {
 ...
 * (`docs/ACTS-PRD.md`). The app name ("ACTS") is used inline here and will be
 * swept with the rest of the UI when the Oravia rebrand lands (ACTS-144).
 */
function AboutPage() {
  return (
    <AppShell title="About" subtitle="What this is, and why it's here">
      <div className="mx-auto max-w-prose space-y-8 pb-4">
        <p className="border-l-2 border-primary/40 pl-4 font-display text-base italic leading-relaxed text-foreground">
          ...
          become part of a meaningful record of how I am trying to live my faith, discern
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ACTS is a personal faith companion for the whole of your faith journey — helping
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            read, watch, hear, experience, question, and reflect on. ACTS captures that faith
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            family novena someone texted you. ACTS gathers them into one companion, compiling
