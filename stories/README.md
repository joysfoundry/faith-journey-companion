...
|----|------|-------|--------|-----------|-----------|---------|
| [ACTS-101](ACTS-101.md) |  | Rebrand "Faith Journey" → "ACTS" (acronym in header) | In Progress | — | Shipped wordmark + illuminated script tagline (Pinyon) across all headers + all titles/manifest. Pending: JC picks the script font (comparing alternatives) | 2026-08-29 |
