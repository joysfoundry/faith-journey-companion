...
| [ACTS-106](ACTS-106.md) |  | Seed — Eternal Rest Prayer + surface "Why We're Catholic" (Trent Horn) on Home | In Progress | — | **All ACs met + browser-verified** (Home Vessels pin + `/prayer/eternal-rest`; `tsc` clean). Eternal Rest Prayer seeded (`src-eternal-rest`), book retitled + favorited to Home, STORAGE_KEY v29→v30. Ready to `/save` → `/done` | 2026-08-29 |
