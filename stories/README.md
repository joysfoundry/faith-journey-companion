...
| [ACTS-135](ACTS-135.md) |  | Reflection organization — optional themes, no-AI tag suggestions, group-by view | To Do | — | _Design walkthrough w/ JC._ Optional `themes: string[]` (data-shape change); **no-AI** suggestions (curated lexicon + own tag history, dismissible chips — AI semantic tagging = future opt-in, Cloud phase); one-page **Group by: Date/Theme/Source** + asc/desc. Writing stays zero-effort. Lays structure for future insights. Relates ACTS-103/102 | 2026-09-02 |
