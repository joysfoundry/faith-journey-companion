...
| [ACTS-99](ACTS-99.md) |  | Daily rosary defers to a scheduled novena rosary | In Progress | — | Daily rosary always in sessions list; toggle to defer it to a scheduled novena for N days (keeps DAILY ROSARY label, no duplicate, shows "Day X of N", start-date-aware counter); reappears when novena ends; still allow other rosary sessions during deferral | 2026-08-29 |
