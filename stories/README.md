...
|----|------|-------|--------|-----------|-----------|---------|
| [ACTS-121](ACTS-121.md) |  | Name + pronoun layer — dedicate a session "for whom" | To Do | — | _New (ACTS-107 session-01)._ Session "for whom" (name + pronoun) + compiler token substitution (`{name}`/`{obj}`/`{subj}`). Blank ⇒ plural "the faithful departed / them". Feeds ACTS-119/120, assembled in ACTS-107 | 2026-08-29 |
| [ACTS-120](ACTS-120.md) |  | Seed — Litany of the Faithful Departed + Loreto/BVM + closing collects | To Do | — | _New (ACTS-107 session-01)._ Two new litanies (Faithful Departed generic "them"; Loreto/BVM — not yet seeded) via ACTS-57 model + Fidelium/kindred closing collects as standalone prayers. Feeds ACTS-107 | 2026-08-29 |
| [ACTS-119](ACTS-119.md) |  | Seed — Decade of the Passion (Rosary for the Dead) + How-To | To Do | — | _New (ACTS-107 session-01)._ Passion-focused rosary **version** that replaces the standard rosary (large bead "Merciful Jesus" + 10 sufferings ×5 decades, Sorrowful set). Content captured in ACTS-107. Feeds ACTS-107 | 2026-08-29 |
...
| [ACTS-107](ACTS-107.md) |  | Litany of the Departed devotion (Rosary + Litany structure) | In Progress | ACTS-106 | **Parked stub (spinoff).** Composite Rosary+Litany for the dead: offering/invitation → litany sequence → closing/requiem → Eternal Rest Prayer → Sign of the Cross. Exact wording + composite-devotion modeling = next chat. Reuses litany model (ACTS-57) + Eternal Rest seed (ACTS-106) | 2026-08-29 |
