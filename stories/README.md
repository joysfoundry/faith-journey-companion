...
| [ACTS-97](ACTS-97.md) |  | Land on the browse/list tab by default (Vessels + Plan), not the create tab | In Progress | — | Code done + pushed (`fda1934`); tsc clean; JC spot-checked OK. Handoff [session-01](ACTS-97/session-01.md). Next: `/done` when satisfied (only open AC — browser-preview — covered by spot-check) | 2026-08-28 |
